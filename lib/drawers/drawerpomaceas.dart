...
String num='0';
int especie=0;
class drawerpomaceas extends StatefulWidget {
  static String id = 'Eleccion';

  const drawerpomaceas({super.key});
  @override
  State<drawerpomaceas> createState() => _drawerpomaceas();
}
String fruta='Informe puntos críticos';
class _drawerpomaceas extends State<drawerpomaceas>{
  late File imageFile;
  @override
  void initState(){
    obtenerespecie();
                                            ...
                                            child: InkWell(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(left: 15, right: 65),
                                                    child:Text('Control sanitización', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold))
                                                  ),
                                                ],
                                              ),
                                              onTap: ()
  ...
  Future Guardarinfo(int nums) async{
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla4('/informepomaceas.php'),),
      body: {
