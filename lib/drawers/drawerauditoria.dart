...
String n= "D'";
bool isSelected=false, grafico6=true, loading=false, grafico7=false, grafico3=false;
double largo=0;
double hancho=0;
...
class _drawerauditoria extends State<drawerauditoria>{
                                            ...
                                            child: InkWell(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(left: 15, right: 65),
                                                    child: grafico6? Text('Control hidroenfriado', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)):
                                                    Text('Control patio curado', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold))
                                                  ),
                                                ],
                                              ),
                                              onTap: () async
                                            ...
                                            child: InkWell(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(left: 15, right: 65),
                                                    child: Text('Control cámaras de frio', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)),
                                                  ),
                                                ],
                                              ),
                                              onTap: () async
                                              {
                                                  ...
                                                  if(fechas.length!=0)
                                                {
                                                  ...
                                                  {
                                                    valor6=lg.id_centrales[0];
                                                    if(_currentUser.user.IDPERFIL==5)
                                                    {
                                                      num='3';
                                                    idinforme();
                                                    }
                                            ...
                                            child: InkWell(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(left: 15, right: 65),
                                                    child: grafico6? Text('Sanitización', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)):
                                                    Text('Sanitización de linea', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold))
                                                  ),
                                                ],
                                              ),
                                              onTap: () async
                                            ...
                                            child: InkWell(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.only(left: 15, right: 65),
                                                    child: grafico7? Text('Control pedicelo', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)):
                                                    Text('Cliente especifico', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold))
                                                  ),
                                                ],
                                              ),
                                              onTap: () async
                                  ...
                                  //add more permission to request here.
                                    ...
                                    if(statuses[Permission.storage]!.isGranted)
                                    {
                                      ...
                                      if (dir != null)
                                      {
                                          ...
                                          {
                                            print(e.message);
                                            Fluttertoast.showToast(msg: 'Se supero el tiempo de espera con el servidor, contacte a un administrador');
                                          }
  ...
  Future Guardarinfo(int nums) async{
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla4('/informescr.php'),),
      body: {
  ...
  Future Guardarinfocarozo(int nums) async{
    ...
    {
      var restS = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla4('/informecarozos.php'),),
      body: {
        'idinforme': nums.toString(),
        'num': num
      }
  ...
  Future Guardarinfokiwi(int nums) async{
    ...
    {
      var restS = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla4('/informekiwi.php'),),
      body: {
        'idinforme': nums.toString(),
        'num': num
      }
...
class _PdfViewerPageState extends State<PdfViewerPage> {
  ...
  Future<void> loadNetwork() async {
    ...
    try{
      var url = 'https://controlcalidad.ptichile.com/puntocritico/views/$nombre/imprimir?turno=$valor3&fecha=${fechas[0]}&sp=$especie&idm=1&central=$valor6&exp=${el.nuevoidexportador}';
    final response = await http.get(Uri.parse(url));
    final bytes = response.bodyBytes;
    final dir = await getApplicationDocumentsDirectory();
    var file = File('${dir.path}/archivo1');
    await file.writeAsBytes(bytes, flush: true).timeout(const Duration(seconds: 50));
    setState(() {
      Pfile = file;
    });
