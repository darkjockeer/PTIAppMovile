class Constant{
  ...
  static const String PATH="/Especies/Uvas";
  //Para el login user
  ...
  static const String pdf="https://controlcalidad.ptichile.com/puntocritico/views/uvas/imprimir?turno=0&fecha=12-12-2022&sp=1&idm=1&central=9&exp=6";
