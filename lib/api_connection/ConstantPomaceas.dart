class Constant{
  ...
  static const String PATH="/Especies/Pomaceas";
  //Para el login user
  ...
  static const String pdf="https://controlcalidad.ptichile.com/puntocritico/views/manzanas/imprimir?turno=0&fecha=12-12-2022&sp=7&idm=1&central=9&exp=6";
