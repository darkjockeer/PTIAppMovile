...
List<String> uniquelist =
    lg.centrales.where((country) => seen.add(country)).toList();
List<double> Lineas = [];
List<double> Lineas2 = [];
List<String> fechas = [];
...
class ChartData {
  ChartData(
      {required this.x, required this.y0, required this.y1, required this.y2});
  final String x;
  final double y0;
  final double y1;
  final double y2;
      ...
      if (va) {
        if (contador < 3) {
          ...
          Fluttertoast.showToast(
              msg: "Solo puede seleccionar como maximo 3 lineas");
        }
      } else {
...
class _GraficoTen extends State<Graficoten> {
                              ...
                              onChanged: (catess) async {
                                if (lg.exportador.length != 1) {
                                  ...
                                  var resp = await http.post(
                                    Uri.parse(EndPoints
                                        .generateEndPointsURLInfoExportadores(
                                            "/Exportadores.php")),
                                    body: {'nomexportador': catess.toString()},
                                  );
                                  ...
                                  if (rests.statusCode == 200) {
                                    ...
                                    if (resBody3['success3'] == true) {
                                      for (int x = 0;
                                          x < resBody3["userData3"].length;
                                          x = x + 1) {
                                        lg.centrales.add(resBody3["userData3"]
                                            [x]["NOMCENTRAL"]);
                                      }
                                    } else {
                                      lg.centrales.add(resBody3["userData3"][0]
                                          ["NOMCENTRAL"]);
                                      lg.id_centrales.add(resBody3["userData3"]
                                          [x]["IDCENTRAL"]);
                                    }
                                  }
                                  setState(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextField(
                        decoration: InputDecoration(hintText: el.diaguardado),
                        textAlign: TextAlign.center,
                        controller: valors,
                        readOnly: true,
                        onTap: () async {
                          ...
                          if (pickedDate != null) {
                            ...
                            int day =
                                int.parse(DateFormat("D").format(pickedDate));
                            ...
                            if (valor7 == '') {
                              ...
                              nuevafechaCerezas(semana, central);
                            } else {
                              nuevafechaCerezas(semana, central);
                            }
                          } else {
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (largo.length == 0) {
                            ...
                            if (valors.text.isNotEmpty == true &&
                                isSelected == false) {
                              setState(
                                () {
                                  isSelected = true;
                          ...
                          onPressed: () {
                            if (largo.length == 0) {
                              ...
                              if (valors.text.isNotEmpty == true &&
                                ...
                                Fluttertoast.showToast(
                                    msg:
                                        "Faltan campos por rellenar o el boton ya fue presionado");
                              }
                            }
                          },
                          child: isSelected
                                    ...
                                    if (lg.exportador.length != 1) {
                                      ...
                                      if (rests.statusCode == 200) {
                                        ...
                                        if (resBody3['success1'] == true) {
                                          for (int x = 0;
                                              x < resBody3["userData1"].length;
                                              x = x + 1) {
                                            lg.centrales.add(
                                                resBody3["userData1"][x]
                                                    ["NOMCENTRAL"]);
                                            lg.id_centrales.add(
                                                resBody3["userData1"][x]
                                                    ["IDCENTRAL"]);
                                          ...
                                          lg.centrales.add(resBody3["userData"]
                                              [0]["NOMCENTRAL"]);
                                        }
                                      }
                      ...
                      child: Column(
                        children: [
                          ...
                          TextField(
                            ...
                            readOnly: true,
                            decoration:
                                InputDecoration(hintText: el.diaguardado),
                            onTap: () async {
                              DateTime? pickedDate = await showDatePicker(
                                  context: context,
                                  initialDate: selectedDate,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            IconButton(
                onPressed: () async {
                  ...
                  if (result == ConnectivityResult.none) {
                    ...
                    if (dk.b == 1) {
                      if (_currentUser.user.IDLOGIN == 0 &&
                          _currentUser.user.IDPERFIL == 0) {
      ...
      body: Center(
        ...
        width: MediaQuery.of(context).size.width,
        height: MediaQuery.of(context).size.height,
        decoration: const BoxDecoration(color: Color.fromRGBO(4, 43, 82, 1)),
        child: Column(
  ...
  void comprobarcen() {
    if (_currentUser.user.IDPERFIL == 1 ||
        _currentUser.user.IDPERFIL == 5 ||
        _currentUser.user.IDPERFIL == 6 ||
        _currentUser.user.IDLOGIN == 31 ||
        _currentUser.user.IDPERFIL == 4) {
      if (_currentUser.user.IDLOGIN == 29 ||
          _currentUser.user.IDLOGIN == 46 ||
          _currentUser.user.IDLOGIN == 74 ||
          _currentUser.user.IDPERFIL == 4) {
        siocen = false;
      } else {
        siocen = true;
  ...
  void comprobarexp() {
    if (_currentUser.user.IDLOGIN == 125 ||
        _currentUser.user.IDLOGIN == 190 ||
        _currentUser.user.IDPERFIL == 1) {
      siono = true;
    } else {
      siono = false;
    }
  ...
  void _addSeries() {
    ...
    if (largo.length == 3) {
      chartData1
          .add(ChartData(x: l, y0: Lineas[0], y1: Lineas[7], y2: Lineas[14]));
      chartData1
          .add(ChartData(x: m, y0: Lineas[1], y1: Lineas[8], y2: Lineas[15]));
      chartData1
          .add(ChartData(x: mi, y0: Lineas[2], y1: Lineas[9], y2: Lineas[16]));
      chartData1
          .add(ChartData(x: j, y0: Lineas[3], y1: Lineas[10], y2: Lineas[17]));
      chartData1
          .add(ChartData(x: v, y0: Lineas[4], y1: Lineas[11], y2: Lineas[18]));
      chartData1
          .add(ChartData(x: s, y0: Lineas[5], y1: Lineas[12], y2: Lineas[19]));
      chartData1
          .add(ChartData(x: d, y0: Lineas[6], y1: Lineas[13], y2: Lineas[20]));

      chartData2.add(
          ChartData(x: l, y0: Lineas2[0], y1: Lineas2[7], y2: Lineas2[14]));
      chartData2.add(
          ChartData(x: m, y0: Lineas2[1], y1: Lineas2[8], y2: Lineas2[15]));
      chartData2.add(
          ChartData(x: mi, y0: Lineas2[2], y1: Lineas2[9], y2: Lineas2[16]));
      chartData2.add(
          ChartData(x: j, y0: Lineas2[3], y1: Lineas2[10], y2: Lineas2[17]));
      chartData2.add(
          ChartData(x: v, y0: Lineas2[4], y1: Lineas2[11], y2: Lineas2[18]));
      chartData2.add(
          ChartData(x: s, y0: Lineas2[5], y1: Lineas2[12], y2: Lineas2[19]));
      chartData2.add(
          ChartData(x: d, y0: Lineas2[6], y1: Lineas2[13], y2: Lineas2[20]));
    ...
    for (int x = 0; x < largo.length; x++) {
      if (x == 0) {
        series!.add(ColumnSeries<ChartData, String>(
          ...
          yValueMapper: (ChartData data, _) => data.y0,
        ));
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcerezas1("/graficoprueba.php")),
              body: {
  ...
  Future bbCerezas() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLcerezas1(
                  "/graficoprueba2.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcerezas1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcerezas1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechaCerezas(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLcerezas1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
  ...
  Future aaArandanos() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLarandanos1(
                  "/graficoprueba.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLarandanos1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLarandanos1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechaArandanos(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLarandanos1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
      ).timeout(const Duration(seconds: 9));
      if (restssr.statusCode == 200) {
        var resBody5 = jsonDecode(restssr.body);
  ...
  Future aaPomaceas() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLpomaceas1(
                  "/graficoprueba.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLpomaceas1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLpomaceas1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechapomaceas(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLpomaceas1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
      ).timeout(const Duration(seconds: 9));
      if (restssr.statusCode == 200) {
        var resBody5 = jsonDecode(restssr.body);
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcarozos1("/graficoprueba.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
                'idcentral': central,
  ...
  Future bbCarozos() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLcarozos1(
                  "/graficoprueba2.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcarozos1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLcarozos1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechacarozos(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLcarozos1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
      ).timeout(const Duration(seconds: 9));
      if (restssr.statusCode == 200) {
        var resBody5 = jsonDecode(restssr.body);
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLkiwis1("/graficoprueba.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
                'idcentral': central,
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLkiwis1("/graficoprueba2.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
                'idcentral': central,
  ...
  Future aa1Kiwis() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLkiwis1(
                  "/graficocomercial.php")),
              body: {
                'categoriacomercial': valor2,
                'nomlinea': largo[x],
  ...
  Future aa2Kiwis() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLkiwis1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  Future bb2Kiwis() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLkiwis1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechakiwis(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLkiwis1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
      ).timeout(const Duration(seconds: 9));
      if (restssr.statusCode == 200) {
        var resBody5 = jsonDecode(restssr.body);
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLuvas1("/graficoprueba.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
                'idcentral': central,
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var restssrs = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLuvas1("/graficoprueba2.php")),
              body: {
                'categoriacaja': valor5,
                'nomlinea': largo[x],
                'idcentral': central,
        ...
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(
                  EndPoints.generateEndPointsURLuvas1("/graficocomercial.php")),
              body: {
                'categoriacomercial': valor2,
                'nomlinea': largo[x],
                'idcentral': central,
  ...
  Future bb1Uvas() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLuvas1(
                  "/graficocomercial2.php")),
              body: {
                'categoriacomercial': valor2,
                'nomlinea': largo[x],
  ...
  Future aa2Uvas() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest2 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLuvas1("/retorno1.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  Future bb2Uvas() async {
    try {
      for (int x = 0; x < largo.length; x++) {
        for (int i = 0; i < fechas.length; i++) {
          {
            var rest3 = await http.post(
              Uri.parse(EndPoints.generateEndPointsURLuvas1("/retorno2.php")),
              body: {
                'nomlinea': largo[x],
                'idcentral': central,
                'date': fechas[i]
  ...
  nuevafechauvas(String semana, String v) async {
    print(central);
    try {
      var restssr = await http.post(
        Uri.parse(EndPoints.generateEndPointsURLuvas1("/lineas.php")),
        body: {'idcentral': v, 'fechasemana': semana},
      ).timeout(const Duration(seconds: 9));
      if (restssr.statusCode == 200) {
        var resBody5 = jsonDecode(restssr.body);
