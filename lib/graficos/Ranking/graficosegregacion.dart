// ignore: file_names
// ignore_for_file: import_of_legacy_library_into_null_safe, unused_import, unnecessary_import, unused_local_variable
...
class Graficossegregacion extends StatefulWidget{
    const Graficossegregacion({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _Graficossegregacion createState() => _Graficossegregacion();
  }
int i=0;
class _Graficossegregacion extends State<Graficossegregacion>{
...
List<BarSeries<ChartData, String>>? series;
  ...
  late int count;
    ...
    void initState(){
      ...
      count = 0;
      chartData = <ChartData>[
      ChartData('Ejemplo', 12, 20,2,3,4,5,6,7,8,9,10,6,3,4,5,6),
    ];
                            ...
                            children: [
                              ...
                              onPressed: (){
                                ...
                                else if(valor2 !=0 && isSelected==false)
                                {
                                  isSelected=true;
                                  print(valor);
                                  print('valor2 diferente 0 y seleccionado false');
                                  setState(() {
                                  series!.clear();
                                  aa1();
                                });
  ...
  ids=[];
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/variedad5.php'),),
      body: {
        'variedad':'1',
        'nomorderdesc': 'lopez'
      }
...
void _addSeries() {
    ...
    print('valor');
    print(letra);
    //AQUI MUESTRA LA CANTIDAD DE DATOS POR ESPECIE
    if(letra.length==9)//ROYAL DAWN
    {
      chartData1.add(ChartData('Objetado', calibre5[0], calibre5[1], calibre5[2], calibre5[3],calibre5[4], calibre5[5], calibre5[6], calibre5[7],calibre5[8],0,0,0,0,0,0,0));
      chartData1.add(ChartData('Alternativa', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8],0,0,0,0,0,0,0));
      chartData1.add(ChartData('Asia 2', calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8],0,0,0,0,0,0,0));
      chartData1.add(ChartData('Asia 1', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8],0,0,0,0,0,0,0));
    }
    else if(letra.length==16)//SANTINA,LAPINS,REGINA
    {
      chartData1.add(ChartData('Objetado', calibre5[0], calibre5[1], calibre5[2], calibre5[3],calibre5[4], calibre5[5], calibre5[6], calibre5[7],calibre5[8],calibre5[9],calibre5[10],calibre5[11],calibre5[12], calibre5[13], calibre5[14], calibre5[15]));
      chartData1.add(ChartData('Alternativa', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11],calibre4[12], calibre4[13], calibre4[14], calibre4[15]));
      chartData1.add(ChartData('Asia 2', calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11],calibre3[12], calibre3[13], calibre3[14], calibre3[15]));
      chartData1.add(ChartData('Asia 1', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12], calibre2[13], calibre2[14], calibre2[15]));
      chartData1.add(ChartData('Asia premiun', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12], calibre1[13], calibre1[14], calibre1[15]));
    }
    else if(letra.length==13)//SWEETHEART
    {
      chartData1.add(ChartData('Objetado', calibre5[0], calibre5[1], calibre5[2], calibre5[3],calibre5[4], calibre5[5], calibre5[6], calibre5[7],calibre5[8],calibre5[9],calibre5[10],calibre5[11],calibre5[12],0,0,0));
      chartData1.add(ChartData('Alternativa', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11],calibre4[12],0,0,0));
      chartData1.add(ChartData('Asia 2' ,calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11], calibre3[12], 0, 0,0));
      chartData1.add(ChartData('Asia 1', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12], 0, 0,0));
      chartData1.add(ChartData('Asia premiun', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12], 0, 0,0));
    }
    else if(letra.length==15)//BING
    {
      chartData1.add(ChartData('Objetado', calibre5[0], calibre5[1], calibre5[2], calibre5[3],calibre5[4], calibre5[5], calibre5[6], calibre5[7],calibre5[8], calibre5[9], calibre5[10], calibre5[11],calibre5[12], calibre5[13], calibre5[14],0));
      chartData1.add(ChartData('Alternativa', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11],calibre4[12], calibre4[13], calibre4[14],0));
      chartData1.add(ChartData('Asia 2', calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11],calibre3[12], calibre3[13], calibre3[14],0));
      chartData1.add(ChartData('Asia 1', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12], calibre2[13], calibre2[14],0));
      chartData1.add(ChartData('Asia premiun', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12], calibre1[13], calibre1[14],0));
    }
...
var restssrs = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla2("/segregacion.php")),
      body: {
...
bb1() async 
  {
    ...
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/segregacion2.php')),
      body: {
        'variedad' : valor2.toString(),
    ...
    if(res.statusCode == 200)
      ...
      if(resBodyOfLogin['success']== true)
      {
        for(int i=0; i<5; i++)
        {
          ...
          {
            calibre4.add(double.parse(resBodyOfLogin["solid4"]));
          }
          else if(i==4)
          {
            calibre5.add(double.parse(resBodyOfLogin["solid5"]));
          }
        }
        }
      else
