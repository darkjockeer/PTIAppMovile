...
class Graficosfirmeza extends StatefulWidget{
    const Graficosfirmeza({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _Graficosfirmeza createState() => _Graficosfirmeza();
  }
int i=0;
class _Graficosfirmeza extends State<Graficosfirmeza>{
  ...
  ids=[];
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/variedad4.php'),),
      body: {
        'variedad':'1',
        'nomorderdesc': 'lopez'
      }
...
var restssrs = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla2("/firmeza.php")),
      body: {
...
bb1() async 
  {
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/firmeza2.php')),
      body: {
        'variedad' : valor2.toString(),
