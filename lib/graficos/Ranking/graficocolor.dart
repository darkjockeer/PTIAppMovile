...
class Graficoscolor extends StatefulWidget{
    const Graficoscolor ({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _Graficoscolor  createState() => _Graficoscolor();
  }


class _Graficoscolor  extends State<Graficoscolor >{
  ...
  late int count;
    ...
    void initState(){
      ...
      count = 0;
      chartData = <ChartData>[
      ChartData('Ejemplo', 12, 20,2,3,4,5,6,7,8,9,10,6,3,4,5,2),
    ];
...
void _addSeries() {
    ...
    print(letra.length);
    print(letra);
    if(letra.length==13)//SWEETHEART
    {
      chartData1.add(ChartData('N', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11], calibre4[12],0,0,0));
      chartData1.add(ChartData('C.O' ,calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11], calibre3[12], 0, 0, 0));
      chartData1.add(ChartData('RC(3-3.5-3.8)', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12], 0, 0,0));
      chartData1.add(ChartData('FC-RCL-R', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12],0, 0, 0));
    }
    else if(letra.length==15)//BING
    {
      
      chartData1.add(ChartData('N',             calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11],calibre4[12], calibre4[13], calibre4[14],0));
      chartData1.add(ChartData('C.O',           calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11],calibre3[12], calibre3[13], calibre3[14],0));
      chartData1.add(ChartData('RC(3-3.5-3.8)', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12], calibre2[13], calibre2[14],0));
      chartData1.add(ChartData('FC-RCL-R',      calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12], calibre1[13], calibre1[14],0));
    }
    else if(letra.length==9)//ROYAL DAWN
    {
      chartData1.add(ChartData('N', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7], calibre4[8],0, 0,0,0,0,0,0));
      chartData1.add(ChartData('C.O' ,calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7], calibre3[8],0,0,0,0, 0, 0, 0));
      chartData1.add(ChartData('RC(3-3.5-3.8)', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7], calibre2[8],0,0,0,0,0, 0, 0));
      chartData1.add(ChartData('FC-RCL-R', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7], calibre1[8],0,0,0,0,0, 0, 0));
    }
    else if(letra.length==16)//Regina,LAPINS,REGINA
    {
      chartData1.add(ChartData('N', calibre4[0], calibre4[1], calibre4[2], calibre4[3],calibre4[4], calibre4[5], calibre4[6], calibre4[7],calibre4[8], calibre4[9], calibre4[10], calibre4[11],calibre4[12],calibre4[13],calibre4[14],calibre4[15]));
      chartData1.add(ChartData('C.O' ,calibre3[0], calibre3[1], calibre3[2], calibre3[3],calibre3[4], calibre3[5], calibre3[6], calibre3[7],calibre3[8], calibre3[9], calibre3[10], calibre3[11], calibre3[12],calibre3[13],calibre3[14], calibre3[15]));
      chartData1.add(ChartData('RC(3-3.5-3.8)', calibre2[0], calibre2[1], calibre2[2], calibre2[3],calibre2[4], calibre2[5], calibre2[6], calibre2[7],calibre2[8], calibre2[9], calibre2[10], calibre2[11],calibre2[12],calibre2[13], calibre2[14], calibre2[15]));
      chartData1.add(ChartData('FC-RCL-R', calibre1[0], calibre1[1], calibre1[2], calibre1[3],calibre1[4], calibre1[5], calibre1[6], calibre1[7],calibre1[8], calibre1[9], calibre1[10], calibre1[11],calibre1[12],calibre1[13], calibre1[14], calibre1[15]));
    }
    print(letra); 
  ...
  var restssrs = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla2("/color.php")),
      body: {
...
Future bb1() async 
  {
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/color2.php')),
      body: {
        'variedad' : valor2.toString(),
  ...
  ids=[];
    try
    {
      ...
      Uri.parse(EndPoints.generateEndPointsURLtabla2('/variedad3.php'),),
      body: {
        'variedad':'1',
        'nomorderdesc': 'lopez'
      }
