...
int i=0;
class _Colors extends State<Color1>{
  ...
  void _addSeries() {
    ...
    chartData1.add(ChartData('Falta Color' ,calibre1[0], calibre2[0]));
    chartData1.add(ChartData('Rojo Claro', calibre1[1], calibre2[1]));
    chartData1.add(ChartData('Rojo', calibre1[2], calibre2[2]));
    chartData1.add(ChartData('Rojo Caoba 3', calibre1[3], calibre2[3]));
    chartData1.add(ChartData('Rojo Caoba 3.5', calibre1[4], calibre2[4]));
    chartData1.add(ChartData('Rojo Caoba 3.8', calibre1[5], calibre2[5]));
    chartData1.add(ChartData('Caoba Oscuro', calibre1[6], calibre2[6]));
    chartData1.add(ChartData('Negro', calibre1[7], calibre2[7]));
  ...
  var restssrs = await http.post(
      Uri.parse(EndPoints.generateEndPointsURLtabla3("/color.php")),
      body: {
        'idcentral': id,
