...
String imagen='';
String obs='';
class chidro extends StatefulWidget{
    const chidro({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _chidro createState() => _chidro();
  }
int i=0;
class _chidro extends State<chidro>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: PreferredSize(
        ...
        (
          centerTitle: true,
          title: Text('Control hidroenfriado'),
