...
String imagen='';
String obs='';
class cfrio extends StatefulWidget{
    const cfrio({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _cfrio createState() => _cfrio();
  }
int i=0;
class _cfrio extends State<cfrio>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: PreferredSize(
        ...
        (
          centerTitle: true,
          title: Text('Control cámaras de frio'),
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                ...
                                children: [
                                  Text('Cámara espera\nproceso', style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('Cámara \n mantención', style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(nombre[0], style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(nombre[1], style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
