...
String imagen='';
String obs='';
class ctemperatura extends StatefulWidget{
    const ctemperatura({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _ctemperatura createState() => _ctemperatura();
  }
int i=0;
class _ctemperatura extends State<ctemperatura>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: PreferredSize(
        ...
        (
          centerTitle: true,
          title: Text('Control T° interplanta'),
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                child: Row(
                                  ...
                                  children: [
                                    Text('Recepción', style: TextStyle(color:Colors.white),),
                                  ],
                                ),
                                onTap: ()
                                {
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Text('Segregación', style: TextStyle(color:Colors.white),),
                                  ],
                                ),
                                onTap: ()
                                {
