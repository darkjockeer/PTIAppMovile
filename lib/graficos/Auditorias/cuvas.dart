...
String imagen='';
String obs='';
class cuvas extends StatefulWidget{
    const cuvas({Key? key}): super(key: key);
    @override
   // ignore: library_private_types_in_public_api
   _cuvas createState() => _cuvas();
  }
int i=0;
class _cuvas extends State<cuvas>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: PreferredSize(
        ...
        (
          centerTitle: true,
          title: Text('Cámara paletizaje y mantención'),
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                ...
                                children: [
                                  Text('Cámara paletizaje y mantención', style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('${n}agen', style: TextStyle(color:Colors.white),),
                                ],
                              ),
                              onTap: ()
                              {
